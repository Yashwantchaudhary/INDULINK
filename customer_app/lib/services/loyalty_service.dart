...
class LoyaltyService {
  ...
  Future<Map<String, dynamic>> getLoyaltyPoints() async {
    try {
      ...
      developer.log('Error fetching loyalty points: $e', name: 'LoyaltyService', error: e);
      rethrow;
    }
  }
  ...
  Future<List<LoyaltyTransaction>> getTransactions({
    ...
    try {
      ...
      if (response.statusCode == 200 && response.data['success'] == true) {
        ...
        return transactionsData.map((json) => LoyaltyTransaction.fromJson(json)).toList();
      }
      
      return [];
    } catch (e) {
      developer.log('Error fetching transactions: $e', name: 'LoyaltyService', error: e);
      rethrow;
    }
  }
  ...
  Future<List<Badge>> getAllBadges() async {
    try {
      ...
      developer.log('Error fetching badges: $e', name: 'LoyaltyService', error: e);
      rethrow;
    }
  }
  ...
  Future<List<Badge>> getUserBadges() async {
    try {
      ...
      developer.log('Error fetching user badges: $e', name: 'LoyaltyService', error: e);
      rethrow;
    }
  }
  ...
  Future<List<Map<String, dynamic>>> getLoyaltyTiers() async {
    try {
      ...
      developer.log('Error fetching tiers: $e', name: 'LoyaltyService', error: e);
      rethrow;
    }
  }
  ...
  Future<bool> redeemPoints({
    ...
    try {
      ...
      developer.log('Error redeeming points: $e', name: 'LoyaltyService', error: e);
      rethrow;
    }
  }
}
